...
namespace Localizard.Migrations
{
    ...
    [Migration("20241112101408_ManyToManyRelationShipIsAdded")]
    partial class ManyToManyRelationShipIsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Localizard.Domain.Entites.ProjectDetailTranslation", b =>
                {
                    ...
                    b.HasKey("ProjectDetailId", "TranslationId");
            ...
            modelBuilder.Entity("Localizard.Domain.Entites.ProjectInfoLanguage", b =>
                {
                    b.Property<int>("ProjectInfoId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ProjectInfoId", "LanguageId");

                    b.HasIndex("LanguageId");

                    b.ToTable("ProjectInfoLanguage");
                });
            ...
            modelBuilder.Entity("Localizard.Domain.Entites.ProjectDetailTranslation", b =>
                {
                    b.HasOne("Localizard.Domain.Entites.ProjectDetail", "ProjectDetail")
                        .WithMany("ProjectDetailTranslations")
            ...
            modelBuilder.Entity("Localizard.Domain.Entites.ProjectDetail", b =>
                {
                    b.Navigation("ProjectDetailTranslations");
            ...
            modelBuilder.Entity("Localizard.Domain.Entites.ProjectInfo", b =>
                {
                    ...
                    b.Navigation("ProjectInfoLanguages");
                });
